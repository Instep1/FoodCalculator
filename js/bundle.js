...
function cards() {
  var Card = /*#__PURE__*/function () {
    function Card(img, alt, title, descr, price, parentSelector) {
    ...
    return _createClass(Card, [{
      ...
      value: function render() {
        ...
        element.innerHTML = "<img src=".concat(this.img, " alt=").concat(this.alt, "><h3 class=\"menu__item-subtitle\">").concat(this.title, "</h3><div class=\"menu__item-descr\">").concat(this.descr, "</div><div class=\"menu__item-divider\"></div><div class=\"menu__item-price\"><div class=\"menu__item-cost\">\u0426\u0435\u043D\u0430:</div><div class=\"menu__item-total\"><span>").concat(this.price, "</span> \u0440\u0443\u0431/\u0434\u0435\u043D\u044C</div></div>");
...
function slider(_ref) {
  ...
  next.addEventListener('click', function () {
    if (offset == deleteNum(width) * (slides.length - 1)) {
      offset = 0;
    } else {
  ...
  prev.addEventListener('click', function () {
    if (offset == 0) {
      offset = deleteNum(width) * (slides.length - 1);
    } else {
      offset -= deleteNum(width);
    }
    slidesField.style.transform = "translateX(-".concat(offset, "px)");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2025-06-11');
